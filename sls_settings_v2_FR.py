...
embedding_path='new_exp_fr/my_embedding_file.txt'
...
formal_test_path='data/Family_Relationships/test/formal'
...
#output:
# suffix='_3'
train_pkl_path='new_exp_fr/data/informal2formal.nmt.train.pkl'
val_pkl_path='new_exp_fr/data/informal2formal.nmt.val.pkl'
test_pkl_path='new_exp_fr/data/informal2formal.nmt.test.pkl'
inf2fm_bleu_val_pkl_path='new_exp_fr/data/inf2fm_val.pkl'
fm2inf_bleu_val_pkl_path='new_exp_fr/data/fm2inf_val.pkl'
# add_data_big_pkl_path='/content/new_exp_fr/add_data_big.pkl'
...
class train_parameters(parameters):
    def __init__(self,arch_type='rnn'):
        ...
        self.ckpt_for_infer='new_exp_fr/s2s_sls_infer'
        self.ckpt_for_train='new_exp_fr/s2s_sls_train'
        self.last_ckpt_for_infer = 'new_exp_fr/infer'
        self.last_ckpt_for_train = 'new_exp_fr/train'
...
class generate_parameters(parameters):
    def __init__(self,arch_type="rnn"):
        ...
        self.model_path = 'new_exp_fr/sls_rnn_best.4300.model'
        self.ckpt_for_infer = 'new_exp_fr/s2s_sls_infer'
        self.ckpt_for_train = 'new_exp_fr/s2s_sls_train'
        self.batch_size = 128
